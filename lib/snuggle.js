...
var buildCombiningInfo = function (err, result, originalPath) {
    ...
    // if (_.has(config.combined, inputFilePath)) {
    //     combinedFilePaths = config.combined[inputFilePath];
    // } else {
    //     combinedFilePaths = [config['default_' + finalFileExtension + '_filename']];
};
